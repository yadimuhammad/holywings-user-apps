  ...
  Widget build(BuildContext context) {
    return Obx(
      () {
        ...
        if (controller.state.value == ControllerState.loading && controller.arrActive.isEmpty) {
          return loadingState();
        }
        ...
        if (status == 1 && controller.arrActive.isEmpty) {
          return emptyState();
        }
        ...
        return refreshable(
            ...
            child: Column(
              ...
              children: [
                ListView.builder(
                  itemCount: status == 1 ? controller.arrActive.length : controller.arrExpired.length,
                  shrinkWrap: true,
                  physics: NeverScrollableScrollPhysics(),
                  itemBuilder: (context, int index) {
                    MyVouchersModel model = status == 1 ? controller.arrActive[index] : controller.arrExpired[index];
                ...
                children: [
                  ...
                  if (model.controllers!.enableLoadMore.isTrue)
                    Container(
                      ...
                      child: InkWell(
                        onTap: () => model.controllers!.loadMore(),
                        child: Text(
                          'Load More',
